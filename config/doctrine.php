    ...
    */
    'managers'                   => [
        'default' => [
            ...
            'paths'         => [
                base_path('app/Domain/Model/Favorite'),
                base_path('app/Movie/Model/Favorite'),
                base_path('app/Payment/Model/Favorite'),
                base_path('app/Subscription/Model/Favorite'),
                base_path('app/User/Model/Favorite'),
            ],
